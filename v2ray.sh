...
#注意https://*.hijk.art已挂，此类错误可忽略，须注释掉278-283
#一键安装 bash <(curl -sL https://raw.githubusercontent.com/hijkpw/scripts/master/v2ray.sh)
#wget https://raw.githubusercontent.com/hijkpw/scripts/master/v2ray.sh
